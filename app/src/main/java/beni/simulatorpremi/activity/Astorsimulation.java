...
public class Astorsimulation extends AppCompatActivity {
    ...
    SeekBar seekBar1;
    TextView tjh_amount, lemparA,lemparB,lemparMin,lemparMax ,PA_amount;
    Button lanjut;
    Button sbutton;
    RadioGroup Usage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PA_amount = (TextView) findViewById(R.id.tjh_amount);
...
//            String TKI2 = TKIi;
        ...
        System.out.println(TahunKendaraan);
    ...
    void tempData() {
        ...
        tjh.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                }else if (tjh_passanger.isChecked()){
                    seekBar1.setEnabled(true);
                } else {
                    seekBar1.setEnabled(false);
                    tjh_amount.setText("Jumlah");
                }
            }
        });
        ...
        seekBar1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar sb, int progress, boolean fromUser) {
                ...
                String prezzo = decimalFormat.format(Integer.parseInt(String.valueOf(progress * 500000)));
                nilaitjh = Integer.parseInt(String.valueOf(progress * 500000));
                nilaiPA = Integer.parseInt(String.valueOf(progress * 500000));
                tjh_amount.setText(prezzo);
                PA_amount.setText(prezzo);
            }
...
//                            hargaKendaraan =df.format(jsonObject.getInt("SI"));
